...
1. **อัปโหลดรูป:**
   ...
   - คลิกเพื่อเลือกไฟล์
   - รองรับ: JPG, PNG, WEBP
   - แนะนำ: ไม่เกิน 20 รูป หรือ 50MB

2. **ประมวลผล:**
   - กดปุ่ม "Reduce Images →"
   - รูปจะถูกย่อใน browser ก่อน (50%)
   - จากนั้นส่งไป optimize บน server (50%)
...
### สำหรับ Vercel (Free/Hobby Plan)
- **ขนาดไฟล์รวม**: แนะนำไม่เกิน 50MB
- **จำนวนรูป**: แนะนำไม่เกิน 20 รูปต่อครั้ง
- **Serverless timeout**: 10 วินาที
...
**หมายเหตุ**: รูปภาพจะถูกย่อขนาดใน browser ก่อนอัปโหลด เพื่อความรวดเร็วและลดขนาดข้อมูล
